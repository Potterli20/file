...
function GetData() {
    ...
    "https://filters.adtidy.org/android/filters/199_optimized.txt"
    ...
    "https://filters.adtidy.org/extension/chromium/filters/99.txt"
    ...
    "https://filters.adtidy.org/windows/filters/100.txt"
