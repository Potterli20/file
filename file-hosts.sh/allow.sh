...
num=`cat allow.txt | wc -l`
echo "! Title: trli's Filter for Allowlist" >> allow.txt
echo "! Description: HOSTS Project" >> allow.txt
echo "! Expires: 24 hours (update frequency)" >> allow.txt
echo "! Homepage: https://file.trli.club:2083/allow/" >> allow.txt
echo "! Version: `TZ=UTC-8 date +"%Y-%m-%d %H:%M:%S"`" >> allow.txt
echo "! Total count: $num" >> allow.txt
