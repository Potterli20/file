...
function GenerateRules() {
    ...
    adguardhome)
        domestic_dns=(
            ...
            "tcp://192.168.2.2:5657"
            "udp://192.168.2.2:5657"
            "udp://192.168.2.2:5857"
            "tcp://192.168.2.2:5857"
            "udp://192.168.2.2:5859"
            "tcp://192.168.2.2:5859"
        )
        foreign_dns=(
            "tcp://192.168.2.2:5757"
            "udp://192.168.2.2:5757"
            "udp://192.168.2.2:5759"
            "tcp://192.168.2.2:5759"
        )
